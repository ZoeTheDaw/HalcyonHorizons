    ...
    public static final RegistryObject<CreativeModeTab> AVIAN_INFIRMARY = CREATIVE_MODE_TABS.register("avian_infirmary",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(HorizonsBlockRegistry.BAOBABE_PLANKS.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(HorizonsBlockRegistry.WET_FLUFFPULP_BLOCK.get());
//                        output.accept(HorizonsBlockRegistry.FLUFFPULP_BRICKS.get());
    ...
    public static final RegistryObject<CreativeModeTab> AURORAL_SUMMIT = CREATIVE_MODE_TABS.register("auroral_summit",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(HorizonsBlockRegistry.GLOWPINE_PLANKS.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(HorizonsBlockRegistry.STRATOSCHIST_BRICKS.get());
                        output.accept(HorizonsBlockRegistry.CRACKED_STRATOSCHIST_BRICKS.get());
                        output.accept(HorizonsBlockRegistry.STRATOSCHIST_BRICK_STAIRS.get());
